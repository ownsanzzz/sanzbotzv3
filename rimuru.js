...
`
   sendButMessage(from, wibu, `created iky ads`, [
        ...
        case 'simi':
              ...
              contentText:`♥️ SanzBotz https://instabio.cc/3092908a5dJF7/`,buttons,headerType:4}
...
`
   sendButMessage(from, wibu, `created ♥️ SanzBotz https://instabio.cc/3092908a5dJF7/`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
`
 ...
 ♥️ SanzBotz`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
 ...
 ♥️ SanzBotz`, imageMessage: imageMsg,
   ...
   buttons =  [
       {buttonId: `${prefix}rules`, buttonText: {displayText: 'S&K'}, type: 1},
                  ...
                  buttonsMessage = {
                  contentText: `${menu}`,
                  footerText:  `♥️ SanzBotz`, imageMessage: imageMsg,
                  buttons: buttons,
                  headerType: 1
   }
  ...
  case 'jedagjedugmemu':
   ...
   buttons =  [
       {buttonId: `${prefix}rules`, buttonText: {displayText: 'S&K'}, type: 1},
                  ...
                  buttonsMessage = {
                  contentText: `${menu}`,
                  footerText:  `♥️ ownersanzzz https://instabio.cc/3092908a5dJF7/`, imageMessage: imageMsg,
                  buttons: buttons,
                  headerType: 1
   }
...
┏━━⬣ MINAT? PM
┃⬡ wa.me/6289504462436
┃⬡ SOSMED OWNER @ownersanzzz https://instabio.cc/3092908a5dJF7/
┃⬡ INSTAGRAM @ownersanzzz
┗━━⬣
`
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 🕊️SIARAN SanzBotz🕊️' 」*\n\n${body.slice(4)}`})
}
